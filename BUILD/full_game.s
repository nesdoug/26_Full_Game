...
;
	jmp     L1BD5
L1F9E:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L1BD5:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
	...
	sec
	sbc     _eject_R
L1FA6:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L1BFF:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L1C09
...
;
L1FA3:	lda     #$00
L1F9B:	sta     _map_loaded
;
; temp5 = BoxGuy1.x;
;
L1C5E:	lda     _BoxGuy1+1
	sta     _temp5+1
	lda     _BoxGuy1
	sta     _temp5
;
